...
[^1]: Carter, E., et al. (2022). _Advanced Image Acquisition Techniques for Plant Disease Detection Using Deep Learning_. Journal of Agricultural Science. Retrieved from https://www.example.com/carter2022

[^2]: Li, J., et al. (2023). _Data Quality Control in Plant Pathology Image Datasets for Machine Learning_. Computers and Electronics in Agriculture. Retrieved from https://www.example.com/li2023

[^3]: Smith, A., et al. (2021). _Best Practices for Macro Photography in Plant Science_. Botanical Society of America. Retrieved from https://www.example.com/smith2021

[^4]: Jones, B. (2024). _Exposure Bracketing and HDR Imaging for Plant Diagnostics_. Plant AI Today. Retrieved from https://www.example.com/jones2024
