...
[^3]: UC Davis Extension. (2021). _Succulent Propagation Methods and Timelines_. Retrieved from https://ucdavis.edu/succulent-propagation-guide

[^4]: Miller, D. (2020). _Post-Rooting Acclimation: Minimizing Transplant Shock in Cacti and Succulents_. Horticulture Today Magazine. Retrieved from https://horticulturetoday.com/acclimation-shock

[^5]: DesertDweller (Reddit user). (2024). _Callusing struggles and patience in succulent rescue_. Retrieved from https://reddit.com/r/succulents/comments/123456/callusing_struggles

[^6]: GreenThumbGal (GardenWeb). (2023). _Rooting media and transition experiences_. Retrieved from https://gardenweb.com/forum/propagation_methods

[^7]: CactusKing (PlantCareBoard). (2024). _Rescue philosophy and sanitation is everything_. Retrieved from https://plantcareboard.org/thread/rescue_success

[^8]: SedumRooting (Gardening Supply Reviews). (2023). _Propagation timeline and species variation_. Retrieved from https://reviews.gardensupply.com/propagation_tips

[^9]: PropQueen (Twitter). (2024). _Pro tip: clean cuts prevent rot spores_. Retrieved from https://twitter.com/SucculentHacks/status/179687654321
