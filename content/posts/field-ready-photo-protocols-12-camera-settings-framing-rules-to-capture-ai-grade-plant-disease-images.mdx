...
[^2]: Barbedo, J. G. A. (2018). _Impact of dataset size and variety on the effectiveness of deep learning and classical machine learning models for plant disease identification_. Biosystems Engineering. Retrieved from https://doi.org/10.1016/j.biosystemseng.2018.10.009

[^3]: Polder, G. et al. (2019). _Plant disease detection using hyperspectral imaging: A review_. Computers and Electronics in Agriculture. Retrieved from https://doi.org/10.1016/j.compag.2019.05.020

[^4]: Lu, Y. et al. (2017). _Identification of rice diseases using deep convolutional neural networks_. Neurocomputing. Retrieved from https://doi.org/10.1016/j.neucom.2017.06.023

[^5]: Singh, V., & Singh, A. K. (2020). _A Survey on Deep Learning Techniques for Plant Disease Detection_. IEEE Access. Retrieved from https://ieeexplore.ieee.org/document/9064904
